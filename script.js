  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      for (let i = 0; i < formElements.length; i++) {
        ...
        if (field.tagName === 'BUTTON' || field.type === 'submit') continue;
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "קבוצת ברום יזמות ובניה בעמ משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '28161a08-d3a2-4f85-a971-9f965bc06cad',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '28161a08-d3a2-4f85-a971-9f965bc06cad';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '28161a08-d3a2-4f85-a971-9f965bc06cad';
